...
class HistoryAdapter (private val list: List<HistoryCacheEntity>, private val mContext: BaseActivity, private val mFragment: BaseFragment) : RecyclerView.Adapter<HistoryAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model: HistoryCacheEntity =list[position]
